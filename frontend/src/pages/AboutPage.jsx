...
export default function AboutPage() {
   ...
   return (
      <div className='px-8 py-12 mt-24 mx-auto max-w-6xl'>
         <h2 className='text-3xl font-worksans font-extrabold mb-4 text-gray-900'>About Us</h2>
         ...
         <section className="flex flex-row justify-items-center items-start mx-auto lg:mx-0">
